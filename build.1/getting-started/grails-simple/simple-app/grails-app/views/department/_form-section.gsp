    ...
    <div class="ili-form-section-fields">
        <g:each in="${section.fields ?: []}" var="fieldName">
            ...
            <g:else>
                ...
                <g:set var="fieldHasErrors" value="${hasErrors(bean: this.department, field: fieldName)}" />
                <div id="field-${fieldName}"
                     class="ili-form-field ${hasErrors(bean: this.department, field: fieldName, 'has-error')}"
                     data-form-field="${fieldName}">
                    <f:field bean="department"
                             property="${fieldName}"
                             label="${message(code: 'department.' + fieldName + '.label', default: fieldInfo.label ?: fieldName)}"
                    ...
                    <g:hasErrors bean="${this.department}" field="${fieldName}">
                        <div id="field-${fieldName}-error" class="invalid-feedback d-block" data-field-error="${fieldName}">
                            <g:eachError bean="${this.department}" field="${fieldName}" var="error">
