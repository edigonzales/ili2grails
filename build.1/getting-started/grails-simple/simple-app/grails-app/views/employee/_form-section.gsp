    ...
    <div class="ili-form-section-fields">
        <g:each in="${section.fields ?: []}" var="fieldName">
            ...
            <g:else>
                ...
                <g:set var="fieldHasErrors" value="${hasErrors(bean: this.employee, field: fieldName)}" />
                <div id="field-${fieldName}"
                     class="ili-form-field ${hasErrors(bean: this.employee, field: fieldName, 'has-error')}"
                     data-form-field="${fieldName}">
                    <f:field bean="employee"
                             property="${fieldName}"
                             label="${message(code: 'employee.' + fieldName + '.label', default: fieldInfo.label ?: fieldName)}"
                    ...
                    <g:hasErrors bean="${this.employee}" field="${fieldName}">
                        <div id="field-${fieldName}-error" class="invalid-feedback d-block" data-field-error="${fieldName}">
                            <g:eachError bean="${this.employee}" field="${fieldName}" var="error">
