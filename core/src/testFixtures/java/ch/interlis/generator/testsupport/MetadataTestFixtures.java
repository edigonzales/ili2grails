...
public final class MetadataTestFixtures {
    ...
    public static void createAssociationCasesIli2dbFixture(Connection connection) throws Exception {
        try (Statement stmt = connection.createStatement()) {
            ...
            stmt.execute("INSERT INTO t_ili2db_classname VALUES " +
                "('AssociationCases.Extended.TernaryAssociation', 'ternaryassociation')");
            stmt.execute("INSERT INTO t_ili2db_classname VALUES " +
                "('AssociationCases.Extended.ExtendedTopicAssociation', 'extendedtopicassociation')");
            stmt.execute("INSERT INTO t_ili2db_classname VALUES " +
                "('AssociationCases.Base.OrderedAssociation', 'orderedassociation')");
            ...
            stmt.execute("INSERT INTO t_ili2db_table_prop VALUES ('ternaryassociation', 'ASSOCIATION')");
            stmt.execute("INSERT INTO t_ili2db_table_prop VALUES ('orderedassociation', 'ASSOCIATION')");
            ...
            stmt.execute("INSERT INTO t_ili2db_attrname VALUES " +
                "('PersonRole', 'person_role_id', 'AssociationCases.Extended.TernaryAssociation', " +
                    "'AssociationCases.Base.Person')");
            stmt.execute("INSERT INTO t_ili2db_attrname VALUES " +
                "('ParcelRole', 'parcel_role_id', 'AssociationCases.Extended.TernaryAssociation', " +
                    "'AssociationCases.Base.Parcel')");
            stmt.execute("INSERT INTO t_ili2db_attrname VALUES " +
                "('DocumentRole', 'document_role_id', 'AssociationCases.Extended.TernaryAssociation', " +
                    "'AssociationCases.Base.Document')");
            stmt.execute("INSERT INTO t_ili2db_attrname VALUES " +
                "('Note', 'note', 'AssociationCases.Extended.TernaryAssociation', NULL)");
            stmt.execute("INSERT INTO t_ili2db_attrname VALUES " +
                "('Owner', 'owner_id', 'AssociationCases.Base.OrderedAssociation', " +
                    "'AssociationCases.Base.Person')");
            stmt.execute("INSERT INTO t_ili2db_attrname VALUES " +
                "('Docs', 'docs_id', 'AssociationCases.Base.OrderedAssociation', " +
                    "'AssociationCases.Base.Document')");
            ...
            stmt.execute(
                "CREATE TABLE ternaryassociation (" +
                    "t_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, " +
                    "person_role_id INTEGER NOT NULL, " +
                    "parcel_role_id INTEGER NOT NULL, " +
                    "document_role_id INTEGER, " +
                    "note VARCHAR(50), " +
                    "FOREIGN KEY (person_role_id) REFERENCES person(t_id), " +
                    "FOREIGN KEY (parcel_role_id) REFERENCES parcel(t_id), " +
            ...
            stmt.execute(
                "CREATE TABLE orderedassociation (" +
                    "t_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, " +
                    "owner_id INTEGER NOT NULL, " +
                    "docs_id INTEGER, " +
                    "FOREIGN KEY (owner_id) REFERENCES person(t_id), " +
                    "FOREIGN KEY (docs_id) REFERENCES document(t_id)" +
                    ")"
            );
        }
    }
