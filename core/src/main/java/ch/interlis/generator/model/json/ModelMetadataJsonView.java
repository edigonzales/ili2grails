...
/**
 * Deterministische JSON-View über die immutable Core-IR.
 *
 * <p>Die View liest ausschliesslich Getter; sie mutiert nichts. Abgeleitete
 * Darstellungen (z. B. Relationships zusätzlich unter Klassen) können über
 * {@link LegacyModelMetadataJsonView} erzeugt werden, ohne die IR doppelt zu
 * speichern.</p>
 */
public class ModelMetadataJsonView {

    private static final String METADATA_FORMAT_VERSION_KEY = "metadataFormatVersion";

    public Map<String, Object> toDto(ModelMetadata metadata) {
        return toDto(metadata, true);
    }

    public Map<String, Object> toDto(ModelMetadata metadata, boolean includeFormatMarker) {
        Map<String, Object> dto = new LinkedHashMap<>();
        if (includeFormatMarker) {
            dto.put(METADATA_FORMAT_VERSION_KEY, 2);
        }
        ...
        if (metadata.getImportDate() != null) {
            dto.put("importDate", metadata.getImportDate().toString());
        }
    ...
    protected Map<String, Object> classDto(ClassMetadata classMetadata) {
        Map<String, Object> dto = new LinkedHashMap<>();
    ...
    protected Map<String, Object> attributeDto(AttributeMetadata attribute) {
        Map<String, Object> dto = new LinkedHashMap<>();
    ...
    protected Map<String, Object> targetHintsDto(AttributeMetadata attribute) {
        Map<String, Object> dto = new LinkedHashMap<>();
        putIfNotNull(dto, "javaType", attribute.getJavaType());
        return dto;
    }

    protected Map<String, Object> constraintsDto(ch.interlis.generator.model.AttributeConstraints constraints) {
        Map<String, Object> dto = new LinkedHashMap<>();
        if (constraints == null) {
            return dto;
        }
    ...
    protected Map<String, Object> associationDto(AssociationMetadata association) {
        Map<String, Object> dto = new LinkedHashMap<>();
    ...
    protected Map<String, Object> associationRoleDto(AssociationRoleMetadata role) {
        Map<String, Object> dto = new LinkedHashMap<>();
    ...
    protected Map<String, Object> enumDto(EnumMetadata enumMetadata) {
        Map<String, Object> dto = new LinkedHashMap<>();
    ...
    protected List<Map<String, Object>> enumValueDtos(List<EnumMetadata.EnumValue> values) {
    ...
    protected Map<String, Object> relationshipDto(RelationshipMetadata relationship) {
        Map<String, Object> dto = new LinkedHashMap<>();
    ...
    protected Map<String, Object> cardinalityDto(Cardinality cardinality) {
        Map<String, Object> dto = new LinkedHashMap<>();
    ...
    protected Comparator<AttributeMetadata> attributeComparator() {
        return Comparator
    ...
    protected Comparator<RelationshipMetadata> relationshipComparator() {
        return Comparator
    ...
    protected Comparator<AssociationRoleMetadata> associationRoleComparator() {
        return Comparator
    ...
    protected void putIfNotNull(Map<String, Object> dto, String key, Object value) {
        if (value != null) {
            dto.put(key, value);
        }
    }
