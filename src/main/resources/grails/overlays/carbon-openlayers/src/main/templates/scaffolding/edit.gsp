...
<div id="content" role="main" class="ili-page ili-page-form">
    <section class="ili-page-header">
        <div>
            <h1 class="ili-page-title"><g:message code="default.edit.label" args="[entityName]" /></h1>
            <p class="ili-page-subtitle">Bestehende Entität aktualisieren.</p>
        </div>
    ...
    <g:form resource="\${this.${propertyName}}" controller="\${controllerName}" method="PUT" class="ili-form">
