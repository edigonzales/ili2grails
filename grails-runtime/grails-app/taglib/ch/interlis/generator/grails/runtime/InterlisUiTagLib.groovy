...
class InterlisUiTagLib {
    ...
    private static final Map<String, String> ICON_PATHS = [
        ...
        "check-circle": '''<path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/> <path d="m10.97 5.97-3.5 3.5-1.5-1.5a.75.75 0 0 0-1.06 1.06l2.03 2.03a.75.75 0 0 0 1.06 0l4.03-4.03a.75.75 0 0 0-1.06-1.06"/>''',
        ...
        "exclamation-triangle": '''<path d="M7.938 2.016a.5.5 0 0 1 .924 0l6.857 13.5A.5.5 0 0 1 15.272 16H.728a.5.5 0 0 1-.447-.724zM8.5 6.5a.5.5 0 0 0-1 0v3a.5.5 0 0 0 1 0zm-1 5a.5.5 0 1 0 1 0 .5.5 0 0 0-1 0"/>''',
